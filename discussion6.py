...
###############################################################################
    ...
    def horse_fastest_race(self, horse):
        ...
        if horse not in self.race_dict:
            return (None, 999.9)
        races_times = self.race_dict[horse]
        fastest_race, fastest_time = min(races_times.items(), key=lambda x: x[1])
...
###############################################################################
    ...
    def horse_personal_best(self):
        ...
        '''
        return {horse: self.horse_fastest_race(horse) for horse in self.race_dict}
...
###############################################################################
    ...
    def get_average_time(self):
        ...
        '''
        result = {}
        for horse, races_times in self.race_dict.items():
            times = list(races_times.values())
            result[horse] = sum(times) / len(times)
        return result
